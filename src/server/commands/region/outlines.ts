...
const registerInformation: CommandInfo = {
    name: "outlines",
    permission: "worldedit.region.outlines",
    description: "commands.wedit:outlines.description",
    usage: [
...
registerCommand(registerInformation, function* (session, builder, args) {
    ...
    const count = yield* Jobs.run(session, 2, shape.generate(loc, pattern, mask, session, { edges: true }));
